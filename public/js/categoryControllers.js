...
;
        ...
        var listaCategoriaBD = [
            ...
            ,"chatOnline", "bloqueos_vox", "agradecimiento", "app", "beneficios"];
            ...
            $http({method: 'GET', url: '/queryTotalCategory'}).success(function (data, status, headers, config) {
                ...
                $http({
                    ...
                    success(function(data, status, headers, config) {
                        ...
                        var listaJerarquias = ['Llamadas', 'Bloqueos',  'Sucursal', 'Cajero',
                            'Aplicacion Itau', 'Login', 'Caida Portal',
                            'Servicios Portal', 'Chat Online',  'Cuenta Corriente', 'Credito',
                            'Seguros',  'Solicitudes', 'Transacciones', 'Clonacion',
                            'Fraude', 'Phishing', 'Sernac', 'Beneficios',
                            'Reclamos', 'Consultas', 'Agradecimientos',
                            'Portal Itau','Tarjeta','Atencion al Cliente',
                            'Seguridad','Productos Persona','Servicios Online','Call Center','Presencial','Categorias'];
                        ...
                        //Categorias
                        diccionario_categoria['Categorias'].hijos =  ['Call Center','Presencial','Servicios Online','Productos Persona',
                            'Seguridad', 'Atencion al Cliente'];


                        //Vox

                        diccionario_categoria['Call Center'].hijos = ['Llamadas', 'Bloqueos'];

                        //Precencial
                        diccionario_categoria['Presencial'].hijos = ['Sucursal', 'Cajero'];

                        //Canales Criticos
                        diccionario_categoria['Servicios Online'].hijos = ['Portal Itau', 'Aplicacion Itau','Chat Online'];

                        //Portal Itau
                        diccionario_categoria['Portal Itau'].hijos = ['Login', 'Caida Portal', 'Servicios Portal'];
                        ...
                        //Seguridad
                        diccionario_categoria['Seguridad'].hijos = ['Fraude', 'Phishing', 'Sernac'];
                        //Categorias de la BD
                        diccionario_categoria['Llamadas'].hijos =  ['llamadas_vox'];
                        diccionario_categoria['Bloqueos'].hijos = ['bloqueos_vox'];
                        ...
                        diccionario_categoria['Aplicacion Itau'].hijos = ['app'];
                        ...
                        diccionario_categoria['Phishing'].hijos = ['phishing'];
                        ...
                        bubble(seriesBubble('Categorias','nn'),"bubble2",diccionario_categoria["Categorias"]["hijos"]);
                        ...
                        document.getElementById("tweetList1.5").style.height = $("#bubble2").height() + $("#bottonbubble").height() + "px";
